[![Actions Status](https://github.com/bytewax/bytewax-rolling/workflows/CI/badge.svg)](https://github.com/bytewax/bytewax-rolling/actions)
[![PyPI](https://img.shields.io/pypi/v/bytewax-rolling.svg?style=flat-square)](https://pypi.org/project/bytewax-rolling/)
[![Bytewax User Guide](https://img.shields.io/badge/user-guide-brightgreen?style=flat-square)](https://docs.bytewax.io/projects/rolling/en/stable/index.html)
...
`bytewax-rolling` is commercially licensed with publicly available
