...
myst_url_schemes = {
    "gh-issue": {
        "url": "https://github.com/bytewax/bytewax-rolling/issues/"
        "{{ path }}#{{ fragment }}",
        "title": "Issue #{{path}}",
        "classes": ["github"],
    },
    "gh-path": {
        "url": f"https://github.com/bytewax/bytewax-rolling/blob/{git_id}" "#{path}}#",
        "title": "bytewax/bytewax-rolling{{ path }}",
        "classes": ["github"],
    },
    "http": None,
    "https": None,
...
# above directory.
autodoc2_packages = ["../src/bytewax/rolling"]
